...
def get_qprof_evento_nfe():
  ...
  if len(df.index)>0:
    ...
    try: 
      ...
      fn_inserirRegistros(cnx.conn, df_final, "extract.qprof_evento_nfe")
      run_procedure('extract.sp_merger_qprof_evento_nfe()')
